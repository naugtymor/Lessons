...
let goods2 = new Goods('Notebook', '500 euro', 'add_shopping_cart', '5', '.out-4')
goods2.draw();
...
let goods3 = new Goods2('Notebook', '500 euro', 'add_shopping_cart', '5', '.out-6', true)
goods3.draw();
...
let valid1 = new Valid('nikit', '12345', false);
valid1.validate();
...
let valid2 = new Valid('nikit', '1234567', false);
valid2.validate();
...
let valid_2 = new Valid2('', '123456789');
valid_2.validate()
console.log(valid_2)

// email, password, isValid, emailError = '', passwordError = ''
...
let valid_3 = new Valid2('sdfsdff', '123456789');
valid_3.validate()
console.log(valid_3)
